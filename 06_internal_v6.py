# Internal component 6 - show all jobs final v6
# Jessica Allen
from tkinter import *
...
#### This is the component 6 added to component 2, as I have decided
#### to put it all in the same class, so they need to be together for the
#### component 6 code to work properly
