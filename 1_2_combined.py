# Internal entry boxes and checking input
from tkinter import *
...
class Enter_Jobs:
    ...
    def __init__(self, parent):
        ...
        self.show_jobs_button = Button(self.button_frame, text = "Show all Jobs",
                                       command = lambda: self.to_view(), highlightbackground = '#002564', fg = 'Black', borderwidth = 4,
                                       font=button_font)
...
##        heading = Label(self.help_frame, text = "Instructions", justify=LEFT, width = 40,
##                        bg = background, wrap = 250, fg="white", font="20 bold")
...
class View_jobs:
    def __init__(self, partner):
        ...
        self.job_label_summary = Label(self.view_frame, text = "Job Number:", bg = '#002564', fg = 'white', padx = 10, pady = 10)
        self.name_label = Label(self.view_frame, text = "Customer Name:", bg = '#002564', fg = 'white', padx = 10, pady = 10)
        self.job_charge_label = Label(self.view_frame, text = "Job Charge ($):", bg = '#002564', fg = 'white', padx = 10, pady = 10)

        self.job_label_summary['font'] = summary_font
        self.name_label['font'] = summary_font
        self.job_charge_label['font'] = summary_font
        ...
        self.job_num_output = Label(self.summary_frame, text = (self.job_number), bg = '#002564', fg = 'white', padx = 10, pady = 10)
        self.name_output = Label(self.summary_frame, text = " ", bg = '#002564', fg = 'white', padx = 10, pady = 10)
        self.job_charge_output = Label(self.summary_frame, text = "Not Calculated", bg = '#002564', fg = 'white', padx = 10, pady = 10)

        self.job_num_output['font'] = summary_font
        self.name_output['font'] = summary_font
        self.job_charge_output['font'] = summary_font
